...
urlpatterns = [
    ...
    path('answer/modify/<int:question_id>/',
         answer_views.answer_modify, name='answer_modify'),
    path('answer/delete/<int:question_id>/',
    ...
    path('comment/create/answer/<int:question_id>/',
         comment_views.comment_create_answer, name='comment_create_answer'),
    path('comment/modify/answer/<int:question_id>/',
         comment_views.comment_modify_answer, name='comment_modify_answer'),
    path('comment/delete/answer/<int:question_id>/',
